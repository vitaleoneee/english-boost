...
class AchievementChecker:
    ...
    def check_srs_session_count(self):
        srs_session_count = int(r.get(f'{self.user.username}:{self.user.id}:srs_session_counter') or 0)
    ...
    def check_srs_accuracy_counter(self):
        srs_accuracy_counter = int(r.get(f'{self.user.username}:{self.user.id}:srs_accuracy_counter') or 0)
